...
use primitive::primitive_equal_patched;
...
#[inline]
fn equal_values_patched(
    lhs: &ArrayData,
    rhs: &ArrayData,
    lhs_start: usize,
    rhs_start: usize,
    len: usize,
    use_slice_iterator: bool,
) -> bool {
    match lhs.data_type() {
        DataType::UInt8 => {
            primitive_equal_patched::<u8>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::UInt16 => {
            primitive_equal_patched::<u16>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::UInt32 => {
            primitive_equal_patched::<u32>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::UInt64 => {
            primitive_equal_patched::<u64>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Int8 => {
            primitive_equal_patched::<i8>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Int16 => {
            primitive_equal_patched::<i16>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Int32 => {
            primitive_equal_patched::<i32>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Int64 => {
            primitive_equal_patched::<i64>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Float32 => {
            primitive_equal_patched::<f32>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Float64 => {
            primitive_equal_patched::<f64>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Decimal128(_, _) => {
            primitive_equal_patched::<i128>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        DataType::Decimal256(_, _) => {
            primitive_equal_patched::<i256>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        ...
        DataType::Float16 => {
            primitive_equal_patched::<f16>(lhs, rhs, lhs_start, rhs_start, len, use_slice_iterator)
        }
        _ => panic!("Unsupported data type: {:?}", lhs.data_type()),
    }
}
...
pub fn equal_patched(lhs: &ArrayData, rhs: &ArrayData, use_slice_iterator: bool) -> bool {
    utils::base_equal(lhs, rhs)
        && lhs.null_count() == rhs.null_count()
        && utils::equal_nulls(lhs, rhs, 0, 0, lhs.len())
        && equal_values_patched(lhs, rhs, 0, 0, lhs.len(), use_slice_iterator)
}
